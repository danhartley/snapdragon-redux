...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/dan/dan.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/dan/style.scss":
/*!*********************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/dan/style.scss ***!
  \*********************************************************************************************************/
/*! no static exports found */
...
// Module
var code = "\n<header>\n\n  <nav>\n    <ul data-repeat-link=\"{{ navigation }}\">\n      <li>\n        <a href=\"#{{ link }}\">{{ link }}</a>\n      </li>\n    </ul>\n  </nav>\n  \n</header>\n\n<main>\n\n  <h1>\n    Welcome to site optimisation\n  </h1>\n\n  <h2>Checklist</h2>\n\n  <section>\n    <h3>{{ checklist.header }}</h3>\n    <ul data-repeat-check=\"{{ checklist.checks }}\">\n      <li>\n        <dt><a href=\"#\" class=\"task icon\"><i class=\"fas fa-check\" aria-hidden=\"true\"></i><span>{{ check.name }}</span></a></dt><dd>{{ check.value }}</dd>\n      </li>\n    </ul>\n  </section>\n\n  <h2>Tools</h2>\n\n  <section>\n    <h3>{{ toollist.header }}</h3>\n    <ul data-repeat-tool=\"{{ toollist.tools }}\">\n      <li>\n        <span>{{ tool.name }}</span><span><a href=\"{{ tool.link }}\">{{ tool.title }}</a></span>\n      </li>\n    </ul>\n  </section>\n\n<h2>Concepts</h2>\n\n  <section>\n    <h3>{{ conceptList.header }}</h3>\n      <ul data-repeat-concept=\"{{ conceptList.concepts }}\">\n        <li>\n          <dt><a href=\"#\" class=\"task icon\"><i class=\"fas fa-check\" aria-hidden=\"true\"></i><span>{{ concept.name }}</span></a></dt><dd>{{ concept.value }}</dd>\n        </li>\n      </ul>\n  </section>\n\n  <section id=\"{{ toollist.header }}\" style=\"height: 100px;\">\n    some content....\n  </section>\n\n</main>\n\n<footer>\n  <button class=\"clear\">Clear history</button>\n</footer>\n\n";
// Exports
module.exports = code;
...
/* harmony import */ var ui_helpers_templating__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ui/helpers/templating */ "./src/ui/helpers/templating.js");
/* harmony import */ var dan_opt_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dan/opt-api */ "./src/dan/opt-api.js");
/* harmony import */ var dan_about_template_html__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! dan/about-template.html */ "./src/dan/about-template.html");
/* harmony import */ var dan_about_template_html__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(dan_about_template_html__WEBPACK_IMPORTED_MODULE_2__);



var about = function about() {
  var template = document.createElement('template');
  template.innerHTML = dan_about_template_html__WEBPACK_IMPORTED_MODULE_2___default.a;
  var parent = document.querySelector('body');
  Object(ui_helpers_templating__WEBPACK_IMPORTED_MODULE_0__["renderTemplate"])({
    navigation: dan_opt_api__WEBPACK_IMPORTED_MODULE_1__["api"].sections.map(function (section) {
      return section.header;
    }),
    toollist: dan_opt_api__WEBPACK_IMPORTED_MODULE_1__["api"].toollist,
    checklist: dan_opt_api__WEBPACK_IMPORTED_MODULE_1__["api"].checklist,
    conceptList: dan_opt_api__WEBPACK_IMPORTED_MODULE_1__["api"].conceptList
  }, template.content, parent);
  Array.from(document.querySelectorAll('.task')).forEach(function (task) {
...
/* harmony import */ var dan_style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dan/style.scss */ "./src/dan/style.scss");
/* harmony import */ var dan_style_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(dan_style_scss__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var dan_about__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! dan/about */ "./src/dan/about.js");



Object(dan_about__WEBPACK_IMPORTED_MODULE_2__["about"])();
...
/* harmony import */ var dan_opt_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dan/opt-constants */ "./src/dan/opt-constants.js");

var sections = [{
  type: dan_opt_constants__WEBPACK_IMPORTED_MODULE_0__["constants"].TOOLS,
  ...
  type: dan_opt_constants__WEBPACK_IMPORTED_MODULE_0__["constants"].CHECKS,
  header: 'Checklist',
  checks: [{
    name: 'media queries',
  ...
  type: dan_opt_constants__WEBPACK_IMPORTED_MODULE_0__["constants"].CONCEPTS,
  header: 'Concepts',
  concepts: [{
...
var toollist = sections.find(function (section) {
  return section.type === dan_opt_constants__WEBPACK_IMPORTED_MODULE_0__["constants"].TOOLS;
});
var checklist = sections.find(function (section) {
  return section.type === dan_opt_constants__WEBPACK_IMPORTED_MODULE_0__["constants"].CHECKS;
});
var conceptList = sections.find(function (section) {
  return section.type === dan_opt_constants__WEBPACK_IMPORTED_MODULE_0__["constants"].CONCEPTS;
});
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./style.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/dan/style.scss");
...
(function (ns) {
  ...
  ns.Context = function () {//this.doc = (document.currentScript||document._currentScript).ownerDocument;
  ...
  var re = /{{\s([\w\.\^]+)\s}}/g; // Returns 'state' after applying address, where address is an array of
  // string.
  //
  ...
  function expandString(s, state) {
    var match;
    var matches = []; // Flush re's cache of the last string it was parsing.

    re.exec(""); // Find all the matches in s.
        ...
        if (e.attributes != undefined) {
          for (var i = e.attributes.length - 1; i >= 0; i--) {
            ...
            if (attr.name.indexOf('data-repeat') === 0) {
              ...
              if (m != null) {
                var name = attr.name; // Strip trailing "-" from attribute names. This allows
