export const plantae = [
    ...
    {
        term: "Nectar guide",
        definition: 'Marking or pattern seen in flowers that guides pollinators to rewards (nectar/pollen).',
        branch: 'ecology'
    },
    {
        term: "Melittophily",
    ...
    },
    {
        term: 'Photodegradation',
            definition: 'The alteration of materials by light. Typically, the term refers to the combined action of sunlight and air.',
    ...
    {
        term: "Photosynthesis",
        definition: "Process used by plants and other organisms to convert light energy into chemical energy.",
