export const glossary = [
    ...
    {
        term: "Melittophily",
        definition: "Flowers which are pollinated by bees.",
    ...
    {
        term: "Psychophily",
        definition: "Flowers which are pollinated by butterflies.",
    ...
    {
        term: "Phalaenophily",
        definition: "Flowers which are pollinated by moths.",
    ...
    {
        term: 'Zygomorphic',
        definition: '(Of a flower) having only one plane of symmetry, as in a pea or snapdragon; bilaterally symmetrical.'
    },
    {
        term: 'Myophily',
        definition: 'Flowers which are pollinated by flies that normally visit dung or dead animals.',
        characteristics: 'Mimic odour of dung or dead animals.'
    },
    {
        term: 'Ornithophily',
        definition: 'Flowers which are pollinated by birds.',
    ...
    },
    {
        ...
        definition: 'Flowers which are pollinated by bats.',
    ...
    {
        term: 'Cantharophily',
        definition: 'Flowers which are pollinated by beetles.',
    ...
    {
        term: 'Sapromyophily',
        definition: 'Flowers which are pollinated by flies feeding on nectar.',
    ...
    {
        term: "Pollination",
        definition: "The transfer of pollen (male gametes) between the male and female parts of flowers — which enables reproduction of plants."
    },
    {
        term: "Model organism",
