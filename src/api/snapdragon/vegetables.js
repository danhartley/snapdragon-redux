...
//       ],
//       "descriptions": [
//         "<p><em>Cucurbita pepo</em> is a species of squash (family Cucurbitaceae, the gourd or cucumber family) endemic to the New World that includes many common kitchen squash varieties including acorn squash, pumpkin, zucchini, and pattypans (see types listed below).&nbsp; Archeological evidence shows it to be one of the world&rsquo;s earliest domesticated species, first cultivated between 8000-10,000 years ago in Mesoamerica, probably southern Mexico (Smith 1997; Decker 1988). &nbsp;Many molecular studies have investigated the controversial origin of C. pepo and relationship to its two closest relatives, <em>C. fraternal </em>and <em>C. texana</em> (Sanjur et al. 2002; Decker-Walters et al. 2003).&nbsp;&nbsp;</p>\r\n<p style=\"margin-top:.1pt;margin-right:0in;margin-bottom:.1pt;margin-left:0in\"></p>\r\n<p style=\"margin-top:.1pt;margin-right:0in;margin-bottom:.1pt;margin-left:0in\">A broad diversity of inter-fertile<em> C. pepo </em>varieties and subspecies resulted from this 10,000 year cultivation period, producing fruits with such a vast array of different forms, colors and textures that the types are often misidentified as distinct species.&nbsp; These fruits include summer squashes (e.g. zucchini and pattypan), which are eaten as immature fruits with tender skin and soft seeds and winter squashes (e.g.pumpkins and acorn squash) harvested in the fall as mature fruits with tough skin and hardened seeds which are usually removed prior to eating the fruit&rsquo;s flesh. &nbsp;There are also several varieties of inedible gourds exhibiting terrific range in shape, colors, texture and size.&nbsp; Based primarily on fruit shape, Paris (1986) proposed a list of eight basic edible groups and one group of inedible gourds, into which almost all varieties of<em> C. pepo </em>can be classified (listed below; Wikipedia 2013).</p>\r\n<p style=\"margin-top:.1pt;margin-right:0in;margin-bottom:.1pt;margin-left:0in\"></p>\r\n<p style=\"margin-top:.1pt;margin-right:0in;margin-bottom:.1pt;margin-left:0in\"><em>Cucurbita pepo</em> grows as a large annual vine, historically in areas from sea level up to 2000 m. (6500 ft.) in altitude.&nbsp; It has large, showy, yellow-orange, insect-pollinated flowers and round, lobed leaves, often with fine hairy prickles.&nbsp; Like all species in the family, it is frost-sensitive.&nbsp; Various parts of<em> C. pepo</em> plants are edible including the fruit, flowers, young leaves and seeds, and it is an agricultural species of great importance, cultivated around the world.&nbsp; Seeds, leaves, sap and pulp have long been used for medicinal purposes including treatment of intestinal worms, urinary issues, and poultices for burns.&nbsp; The vines and fruit are used as fodder for livestock, and gourds used for a vast array of ornamental, traditional and functional purposes&nbsp;(Kew 2013; Saade and Montes Hernandez 1994; Wikipedia 2013).</p>\r\n<p><strong>Summer squash </strong><em><strong>Cucurbita pepo</strong></em><strong> cultivars include:</strong><br />\r\n&bull;crookneck (var. <em>torticollia</em>),<br />\r\n&bull;straightneck (var. <em>recticollis</em>),<br />\r\n&bull;scallop (var. <em>clypeata</em>),<br />\r\n&bull;zucchini (var. <em>cylindrica</em>),<br />\r\n&bull;cocozzelle (var. <em>longa</em>),<br />\r\n&bull;vegetable marrow (var. <em>fastigata</em>; some forms of this variety, such as spaghetti squash, are winter squashes)<br />\r\n<br />\r\n<strong>Winter squash </strong><em><strong>Cucurbita pepo</strong></em><strong> cultivars include: </strong><br />\r\n&bull;pumpkin (var. <em>pepo</em>),<br />\r\n&bull;acorn squash (var. <em>turbinata</em>)<br />\r\n<br />\r\n<strong>Inedible gourds:</strong><br />\r\n<em>C. pepo</em> var. <em>ovifera</em> (egg-shaped, pear-shaped),<br />\r\n<em>C. pepo</em> var. <em>aurantia</em> (orange color),<br />\r\n<em>C. pepo</em> var. <em>verrucosa</em> (round warty gourds),<br />\r\n<em>C. pepo</em> var. <em>texana</em> ornamental gourds found in Texas (sometimes considered a distinct species, <em>C. texana</em>, this form is possibly the ancestor of <em>C. pepo</em>, although the genetics are complicated and debated)<em>,</em><br />\r\n<em><em>C. pepo</em></em> var. <em>ozarkana</em> ornamental gourds found outside of Texas (Illinois, Missouri, Arkansas, Oklahoma, and Louisiana)</p>\r\n"
//       ],
//       "taxonomy": {
//         "usageKey": 2874508,
...
//       },
//       "family": "Apiaceae",
//       "eolName": "Pastinaca sativa Thomas ex DC."
//     },
//     {
//       "id": 581188,
...
//       ],
//       "descriptions": [
//         "<i>Lactuca sativa</i>, lettuce or garden lettuce, is a leafy annual or perennial herb in the Asteraceae (aster or composite family) that originated in the Mediterranean and Near East and is now cultivated commercially and in home gardens worldwide for its leafy greens, which are the most widely used salad crop. The species, which is not known in the wild but is thought to have been developed from the wild lettuce, <i>L. serriola</i>, around 4,500 years ago in Egypt, has been developed into diverse cultivars that vary in leaf shape (ruffled, toothed, or fairly smooth), growth form (loose clusters of leaves or leaves packed densely into heads to stem lettuce with leaves on edible stems), and leaf color (ranging from light to dark green to reddish to purple, or green tinged with reddish or purple).\r\n\r\nLettuce grows with a basal rosette of leaves up to 15 cm (10 in) long, loosely or tightly clustered, and is generally harvested before the flowering stem has bolted. If allowed to bolt, the plant may reach nearly 1 m (3 ft) tall, with yellow composite flowers that develop tan or black achenes (small, one-seeded fruits with hard coverings that do not split open (dehisce) when ripe) with white beaks. \r\n\r\nLettuce cultivars are generally divided into several groups by growth form:\r\n\r\n1.\tHead or cabbage lettuce, which forms dense, tightly packed heads, like cabbage, and includes the common cultivar ‘Iceberg.’\r\n\r\n2.\tRomaine or cos lettuce, with long (often up to 15 cm, or 10 in), upright, broad-stemmed leaves that form loose heads.\r\n\r\n3.\tCurled or leaf lettuce, with a non-heading rosette of round ruffled, fringed, or crisp leaves.\r\n\r\n4.\tButterhead lettuce, with soft leaves in loose heads.\r\n\r\n5.\tStem lettuce or celtuce, in which the stems are enlarged, and are the part harvested and eaten.\r\n\r\nLettuce is generally eaten fresh in salads, although there are numerous dishes in which the leaves are stuffed, braised, cooked or softened with cream or butter, or pureed. In stem lettuce, the stems are cooked as a vegetable. \r\n\r\nThe FAO estimates that total global commercial production of lettuce was 23.6 million metric tons (mmt) in 2010, harvested from 1.1 million hectares. China led production with 12.6 mmt, just over half the world total, while the second-ranked U.S. produced 4.0 mmt, accounting for another 17%. Italy, India, and Spain were the other countries with harvests of more than 800,000 metric tons. (FAO tracks statistics for lettuce production together with chicory, which includes both <i>Cichorium endivia</i>, endive, and <i>Cichorium intybus</i>, chicory—both of which are used as salad greens, although the root of <i>C. intybus</i> is also harvested to be roasted for use as coffee additive or substitute.) \r\n\r\n(Bailey et al. 1976, FAOSTAT 2012, van Wyk 2005.)"
//       ],
//       "taxonomy": {
//         "usageKey": 7403263,
...
//       },
//       "family": "Apiaceae",
//       "eolName": "Daucus carota subsp. sativus (Hoffm.) Arcang."
//     },
//     {
//       "id": 583899,
...
//       ],
//       "descriptions": [
//         "<i>Brassica oleracea</i>, wild cabbage, is a species in the Brassicaceae (the cabbage or mustard family) from which numerous vegetable crops have been derived, including broccoli, cabbage, cauliflower, collards, Chinese broccoli, Brussels sprouts, kale, curly kale, and kohlrabi, among others. Although the varieties are so numerous as to complicate a general description, the plant is generally stout herbaceous annual, biennial, or occasionally perennial with smooth, glaucous (waxy), rounded lower leaves, which originated in Europe and has been cultivated since Roman times or before. It is most commonly grown in north temperate regions, as it requires a cool growing season and abundant moisture, and its numerous varieties are popular in home gardens.\r\n\r\n<i>B. olearacea</i>, along with the cultivars of <i>B. juncea</i> and <i>B. rapa</i>, have such a long history of cultivation and diversification that it can be difficult to ascertain and classify the relationships among species and varieties (or subspecies). Varieties of <i>B. olearacea</i> are generally placed into the following eight groups:\r\n\r\n1)\tvar. <i>acephala</i>, which includes some types of kale, collards, palm cabbage, and Portuguese cabbage, all used for their leaves, which are generally used as a cooked vegetable or in soups, but are sometimes marinated in dressing and used as a salad. \r\n\r\n2)\tvar. <i>alboglabra</i>, Chinese broccoli or Chinese kale, which produces fleshy stems and crowded flower buds; the stems, flower buds, and young leaves are generally used as a cooked vegetable and are typical in Asian stir fries, soups, and noodle dishes. \r\n\r\n3)\tvar. <i>botrytris</i>, cauliflower, including purple cultivars (Cape broccoli), as well as the pyramid-shaped Italian cultivars (Romanesco), which have large fleshy stems and flower buds that do not open; the stems and buds, which form heads, are served raw in salads or used as a cooked vegetable.\r\n\r\n4)\tvar. <i>capitata</i>, which includes cabbage (sometimes referred to as white cabbage), red cabbage, and Savoy cabbage, in which the large, rounded leaves grow together densely together with a fleshy stem to form a “head,” which is used raw in salads, pickled or fermented (in the German sauerkraut as well as in numerous other regional dishes), or cooked as a vegetable in many northern European cuisines.\r\n\r\n5)\tvar. <i>gemmifera</i>, Brussels sprouts, which forms numerous large axillary buds (where leaf joins stem), with leaves so densely packed as to form small heads, and numerous of these buds ascending a central stalk that can grow to 1 m (3 ft) tall; the buds are used as a cooked vegetable, featured in various typical French dishes. The large stem leaves may also be used as a cooked green.\r\n\r\n6)\tvar. <i>gongylodes</i>, kohlrabi, which has a greatly enlarged, bulbous, above-ground stem, with the leaves often growing in a crown around the outer edge; the stem may be used raw in salads but is more typically cooked and prepared similarly to turnips or used in soups. The leaves may also be used as a cooked green.\r\n\r\n7)\tvar. <i>italica</i>, broccoli, which has thick fleshy stalks and a large head of densely packed flowerbuds; the stems are harvested while flower buds are still immature and tightly closed, and used raw or as a cooked vegetable. Broccoli is a highly nutritious vegetable, with a high vitamin C content and numerous other vitamins and minerals, while low in calories.\r\n\r\n8)\tvar. <i>sabellica</i>, curly and Portuguese kales, which are short-lived perennials from which the leaves can be harvested for several years; the leaves are generally used as a cooked green, notably in Portuguese dishes including the traditional kale soup known as “caldo verde,” but may also be marinated in dressing and used raw in salads.\r\n\r\nStatistics on the production of this diverse group of vegetables are difficult to aggregate. The FAO tracks a category called “cabbages and other Brassica species,” which covers all the varieties of <i>B. olearacea</i> but includes related species as well. However, this category suggests at least the general level of commercial production of these vegetables, which the FAO estimated was 60 million metric tons worldwide in 2010, harvested from 2.1 million hectares. Leading producers were China, India, the Russian Federation, Japan and Korea; the U.S. ranked 9th in total production. \r\n\r\n(Bailey et al. 1976, FAOSTAT 2012, Hedrick 1919, van Wyk 2005.)"
//       ],
//       "taxonomy": {
//         "usageKey": 3042845,
...
//       ],
//       "descriptions": [
//         "The potato is a herbaceous plant that is native to the Andes of South America. The leaves are pinnately divided, very lightly hairy and are usually dark green. The flowers are various shades of white, pink or purple, have 5 petals and the stamens in a bright yellow cone in the middle of the flower. The fruit is shaped like a tomato, but is smaller, green and very bitter. The tubers we eat are the swollen underground stems of the plant; they too come in a wide variety of colors, shapes and sizes.\r\n"
//       ],
//       "taxonomy": {
//         "usageKey": 2930262,
