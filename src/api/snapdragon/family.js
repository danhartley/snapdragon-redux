export const family = [
    {
        name: 'Asteraceae',
        aka: ['Compositae', 'Aster', 'Daisies', 'Composite', 'Sunflower family'],
    ...
    {
        name: 'Apiaceae',
        aka: ['Umbelliferae', 'Umbellifers', 'Celery family', 'Carrot family', 'Parsely family'],
    ...
    {
        name: 'Brassicaceae',
        aka: ['Cruciferae', 'Mustards', 'Crucifers', 'Cabbage family'],
        species: 4060,
        genera: 372,
        description: [
            {
