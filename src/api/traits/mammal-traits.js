...
const getTraits = SD => {    
    ...
    traits: [
        ...
        { name: SD.name.HOST, value: 'Sarcoptes scabiei', type: SD.symbiosis.PARASITISM },
        { name: SD.name.PREDATOR, value: `Oryctolagus cuniculus`, type: SD.symbiosis.PREDATION },
        { name: SD.name.PREDATOR, value: `Rodentia, Lagomorpha`, type: SD.symbiosis.PREDATION },
        { name: SD.name.PREDATOR, value: `Reptilia, Galliformes`, type: SD.symbiosis.PREDATION },
        { name: SD.name.PREDATOR, value: `Insecta, Gastropoda`, type: SD.symbiosis.PREDATION },
        { name: SD.name.PREDATOR, value: `Passeriformes, Annelida`, type: SD.symbiosis.PREDATION },
        { name: SD.name.HERBIVORE, value: `${SD.foodType.NUTS}, ${SD.foodType.BERRIES}`, type: SD.symbiosis.HERBIVORY },
        { name: SD.name.PREY, value: `Canis lupus, Canis latrans`, type: SD.symbiosis.PREDATION },
        { name: SD.name.PREY, value: `Aquila chrysaetos`, type: SD.symbiosis.PREDATION },
    ...
    traits: [            
        ...
        { name: SD.name.DIET, value: SD.diet.OMNIVORE },
        { name: SD.name.ALTRICIAL, value: SD.boolean.YES },
        { name: SD.name.PREY, value: `Martes martes, Felis silvestris`, type: SD.symbiosis.PREDATION },
        { name: SD.name.PREY, value: `Mustela erminea`, type: SD.symbiosis.PREDATION },
        { name: SD.name.PREY, value: `Strigiformes, Accipiter gentilis`, type: SD.symbiosis.PREDATION },
        { name: SD.name.PREY, value: `Buteo, Vulpes vulpes`, type: SD.symbiosis.PREDATION },
        { name: SD.name.HOST, value: 'Squirrel parapoxvirus', type: SD.symbiosis.PARASITISM },
        { name: SD.name.COMPETITOR, value: 'Sciurus carolinensis', type: SD.symbiosis.COMPETITION },
        { name: SD.name.HERBIVORE, value: `${SD.foodType.SEEDS}, Corylus, Fagus`, type: SD.symbiosis.COMMENSALISM },
        { name: SD.name.HERBIVORE, value: `Castanea, Fungi`, type: SD.symbiosis.COMMENSALISM },
    ...
    traits: [
        ...
        { name: SD.name.HERBIVORE, value: `Morus nigra`, type: SD.symbiosis.COMMENSALISM },
        { name: SD.name.HERBIVORE, value: `${SD.foodType.HERBAGE}, Festuca`, type: SD.symbiosis.COMMENSALISM },
        { name: SD.name.HERBIVORE, value: `${SD.foodType.GRASS}, ${SD.foodType.SWARD}`, type: SD.symbiosis.COMMENSALISM },
        { name: SD.name.HOST, value: 'Myxomatosis', type: SD.symbiosis.PARASITISM },
        { name: SD.name.HOST, value: 'Rabbit haemorrhagic disease', type: SD.symbiosis.PARASITISM },
        { name: SD.name.PREY, value: 'Vulpes vulpes, Meles meles', type: SD.symbiosis.PREDATION },
        { name: SD.name.PREY, value: 'Lynx pardinus, Aquila adalberti', type: SD.symbiosis.PREDATION },
        { name: SD.name.PREY, value: 'Mustela putorius, Neovison vison', type: SD.symbiosis.PREDATION },
        { name: SD.name.PREY, value: 'Strigiformes', type: SD.symbiosis.PREDATION },
    ]
    },
    ...
    { 
        ...
        traits: [
            ...
            { name: SD.name.DIET, value: SD.diet.OMNIVORE },
            { name: SD.name.PREDATOR, value: `Erinaceus europaeus`, type: SD.symbiosis.PREDATION },
            { name: SD.name.PREDATOR, value: `Annelida, Insecta`, type: SD.symbiosis.PREDATION },
        ]    
    },
    { 
        name: 'Sus scrofa',
        ...
        traits: [
            ...
            { name: SD.name.DIET, value: SD.diet.OMNIVORE },
            { name: SD.name.HERBIVORE, value: `${SD.foodType.SEEDS}, ${SD.foodType.BERRIES}, ${SD.foodType.NUTS}`, type: SD.symbiosis.COMMENSALISM },
            { name: SD.name.PREDATOR, value: `Annelida, Insecta`, type: SD.symbiosis.PREDATION },
        ]    
    },
    { 
    ...
    traits: [        
            ...
            { name: SD.name.PREDATOR, value: `Amphibia, Crustacea, Insecta`, type: SD.symbiosis.PREDATION },
            { name: SD.name.PREDATOR, value: `Aves, Castor fiber`, type: SD.symbiosis.PREDATION },
        ]    
    },
    { 
    ...
    traits: [        
        ...
        { name: SD.name.PREDATOR, value: `Clupeidae, Engraulidae`, type: SD.symbiosis.PREDATION },
        { name: SD.name.PREDATOR, value: `Merlucciidae, Cephalopoda`, type: SD.symbiosis.PREDATION },
        ]    
    },
    { 
    ...
    traits: [        
        ...
        { name: SD.name.PREDATOR, value: 'Gastropod, Annelida', type: SD.symbiosis.PREDATION },
        { name: SD.name.PREDATOR, value: 'Coleoptera, Lepidoptera', type: SD.symbiosis.PREDATION },
        { name: SD.name.PREDATOR, value: 'Glomeris marginata', type: SD.symbiosis.PREDATION },
        { name: SD.name.PREDATOR, value: 'Tachypodoiulus niger', type: SD.symbiosis.PREDATION },
        { name: SD.name.PREDATOR, value: 'Carabus nemoralis', type: SD.symbiosis.PREDATION },
        { name: SD.name.PREY, value: 'Meles meles', type: SD.symbiosis.PREDATION },
        { name: SD.name.DIET, value: SD.diet.OMNIVORE },
        ]    
    },
]};
