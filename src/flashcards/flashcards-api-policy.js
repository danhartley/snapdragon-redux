export const policyCards = [
  ...
  },
  {
    ...
    definition: '>66%',
    author: 'Decision Making Under Severe Uncertainty (DESEVUN)',
  ...
  },
  {
    ...
    definition: '15%',
    author: 'IPCC Special Report: Impacts of 1.5% global warming.',
    source: 'https://www.ipcc.ch/sr15/chapter/chapter-3/'
  },
  {
  ...
  },
  {
    ...
    source: 'https://scholarship.law.duke.edu/cgi/viewcontent.cgi?article=3172&context=dlj'
  },
  {
  ...
  },
  {
    ...
    definition: 'An estimate of the total future human-caused greenhouse gas emissions in tonnes of CO₂ consistent with limiting warming to a specified figure.',
    author: 'Carbon Tracker',
    source: 'https://carbontracker.org/carbon-budgets-explained/'
  },
  {
    ...
    author: 'IPCC: Uncertainty Guidance',
  ...
  },
  {
    ...
    author: 'IPCC: FAQs',
    source: 'https://www.ipcc.ch/site/assets/uploads/sites/2/2018/12/SR15_FAQ_Low_Res.pdf'
  },
  {
  ...
  },
  {
    ...
    definition: '50%. Tropical rainforests will be able to soak up \'high levels\' of CO₂, but only if they are left intact, and global warming is limited to 2°C.',
    author: 'Carbon Brief',
    source: 'https://www.carbonbrief.org/tropical-forests-can-still-store-high-levels-of-carbon-under-2c-of-warming'
  },
  {
    ...
    author: 'nature',
    source: 'https://www.nature.com/articles/s41586-020-2035-0.epdf?sharing_token=rM2WhZA4wIYxTpeOmWbmetRgN0jAjWel9jnR3ZoTv0NOJ2x2BsrUNZyzCBuuL0UUqQjPW2euF71wbnss7bZVTypLc0eJu3wcwXkQBGokyA9HW2k-okTMHDdectG92AB7UCaAEYubgKcBIjfvWwAarBHNAQlggxcW6gKC8EBuatXyyNG4lsNoKGBuz6jwneDBL85C6ZibPhm8YlwdenuepVVP3nfandk-FdksbHp95BMzbOlkWsOdA_w-AgEHUgpR--O3YMfs5rGobLgW3dErAFzL2HiJnxMDdXmrUYWB9BkPMUDbDoCbz_dFjeO0nPR-hl5fHRzrXiS4FumNJqfhyw%3D%3D&tracking_referrer=www.theguardian.com'
  },
  {
    term: 'According to NASA\'s MODIS data record by how much did the earth green (increase in leaf area) between 2000 and 2020?',
    definition: '5%. China and India account for one-third of the greening.',
    author: 'NASA',
  ...
  {
    term: 'What coverage does MODIS data provide?',
    definition: 'MODIS (Moderate Resolution Imaging Spectroradiometer) takes 1-4 shots of every place on Earth, every day, between 2000 and 2020.',
    author: 'NASA',
    source: 'https://terra.nasa.gov/about/terra-instruments/modis'
  },
  {
  ...
  // },
  {
    ...
    source: 'https://www.ericachenoweth.com/research'
  },
  {
  ...
  },
  {
    ...
    source: 'https://www.nationalarchives.gov.uk/education/leaders-and-controversies/transcript/g6cs2s1t.htm'
  },
  {
    term: 'How does Jared Diamond approach risk in everyday acts?',
    definition: 'With \'constructive paranoia\'',
    author: 'NY Times',
    source: 'https://www.nytimes.com/2013/01/29/science/jared-diamonds-guide-to-reducing-lifes-risks.html'
  },
  // {
  ...
  // },
  {
    ...
    definition: 'Nuclear, wind and solar; as measured in terms of pollution, accidents, and emission of global greenhouse gases.',
    author: 'Our World in Data',
    source: 'https://ourworldindata.org/safest-sources-of-energy'
  },
  {
    term: 'How many modelling cetnres contributed to the most recent IPCC report?',
  ...
  {
    term: 'What is mitigation deterrence?',
    definition: 'The idea that promises of future carbon removal might act as an excuse for avoiding the need to cut emissions today.',
