...
export const dataCards = [
  {
    term: 'What percentage of the world\'s population has never flown?',
    definition: '~80%',
  ...
  {
    term: 'The full impact of flying including contrails and other pollutants e.g. NOx, CH4, contrails is what percentage of global emissions?',
    definition: '~3.5%',
    author: 'Our World in Data',
    source: 'https://ourworldindata.org/co2-emissions-from-aviation'
  },
  {
    term: 'The carbon footprint of cycling one kilometere is in the range of 16-50 grams CO₂eq per km. How does this compare to the Eurostar?',
    definition: 'Eurostar emits 6grams CO₂eq per km per person.',
    author: 'Our World in Data',
    source: 'https://ourworldindata.org/travel-carbon-footprint'
  },
  {
    term: 'How much would you cut your journey\'s footprint by if you took the Eurostar in France instead of a short-haul flight?',
    definition: '~96%.',
    author: 'Our World in Data',
    source: 'https://ourworldindata.org/travel-carbon-footprint'
  },
