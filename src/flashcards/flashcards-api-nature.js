export const natureCards = [
  ...
  },
  {
    ...
    definition: '~12%',
    source: 'https://www.fs.usda.gov/ccrc/topics/grassland-carbon-management'
  },
  {
    term: 'Deforestation already accounts for what percentage of total global carbon emissions?',
    definition: '13%',
    source: 'https://www.ipcc.ch/srccl/'
  },
  {
    term: 'In the past 12,000 years, we have cleared how many trees?',
    definition: '5.8 trillion (nearly half)',
  ...
  {
    term: 'What percentage of trees have been cleared since since the start of the industrial revolution?',
    definition: '32%',
    source: 'https://ipbes.net/sites/default/files/downloads/spm_unedited_advance_for_posting_htn.pdf'
  },
  {
    term: 'What is the increase in biodiversity between open areas and areas with scattered trees?',
    definition: '50-100% higher species richness',
    source: 'https://besjournals.onlinelibrary.wiley.com/doi/full/10.1111/1365-2664.12943'
  },
  {
  ...
  },
  {
    ...
    source: 'https://www.longdom.org/open-access/trees-and-shrubs-with-high-carbon-fixationconcentration-2168-9776-S1-003.pdf'
  },
  {
