...
test('createLessonPlan returns lesson1 screens unchanged for given collection', () => {
    const moduleSize = 2;
...
test('createLessonPlan returns lesson1 missing revision screens for given collection', () => {
    const moduleSize = 2;
